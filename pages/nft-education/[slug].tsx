...
const NftEDucationDetail = ({ newsDetail }: InferGetServerSidePropsType<typeof getServerSideProps>) => {
  return (
    <div>
      ...
      <NewsDetail detail={newsDetail} categoryId={24} />;
    </div>
  );
};

export default NftEDucationDetail;
